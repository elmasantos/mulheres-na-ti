...
result1_df.to_csv("data/temp/sexo_mun_desc"+semestre+".csv")
result2_df.to_csv("data/temp/raca_bairro_desc"+semestre+".csv")
result3_df.to_csv("data/temp/mun_cot_desc"+semestre+".csv")
